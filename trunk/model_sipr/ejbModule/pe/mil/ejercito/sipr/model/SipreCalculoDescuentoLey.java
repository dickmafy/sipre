...
public class SipreCalculoDescuentoLey implements Serializable {
    ...
    public SipreCalculoDescuentoLey(String ctpCodigo, String ccdCodigo, String cpersonaNroAdm, String cplanillaMesProceso, short nplanillaNumProceso) {
        this.sipreCalculoDescuentoLeyPK = new SipreCalculoDescuentoLeyPK(ctpCodigo, ccdCodigo, cpersonaNroAdm, cplanillaMesProceso, nplanillaNumProceso);
    }
