...
public class SiprePlanillaAdicional implements Serializable {
	...
	public SiprePlanillaAdicional(String cpaMesAdicional, String cciCodigo, String ctpCodigo, String cpersonaNroAdm,
			String cplanillaMesProceso, Integer nplanillaNumProceso) {
		this.siprePlanillaAdicionalPK = new SiprePlanillaAdicionalPK(cpaMesAdicional, cciCodigo, ctpCodigo, cpersonaNroAdm,
				cplanillaMesProceso, nplanillaNumProceso);
	}
	...
	public boolean equals(Object object) {
		...
		if ((this.siprePlanillaAdicionalPK == null && other.siprePlanillaAdicionalPK != null)
				|| (this.siprePlanillaAdicionalPK != null && !this.siprePlanillaAdicionalPK.equals(other.siprePlanillaAdicionalPK))) {
			return false;
		}
		return true;
	}
