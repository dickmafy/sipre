...
public class SiprePlanillaDescuentoPK implements Serializable {
    ...
    public String toString() {
        return "pe.mil.ejercito.sipr.model.SiprePlanillaDescuentoPK[ npdCodSec=" + npdCodSec + ", ctpCodigo=" + ctpCodigo + ", cecCodigo=" + cecCodigo + ", cpersonaNroAdm=" + cpersonaNroAdm + ", cplanillaMesProceso=" + cplanillaMesProceso + ", nplanillaNumProceso=" + nplanillaNumProceso + " ]";
    }
