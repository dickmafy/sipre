...
public class SiprePlanillaOtro implements Serializable {
	...
	public String getCpoEst() {
		return cpoEst;
	}

	public void setCpoEst(String cpoEst) {
		this.cpoEst = cpoEst;
	}
	...
	public boolean equals(Object object) {
		...
		if ((this.siprePlanillaOtroPK == null && other.siprePlanillaOtroPK != null)
				|| (this.siprePlanillaOtroPK != null && !this.siprePlanillaOtroPK.equals(other.siprePlanillaOtroPK))) {
			return false;
		}
		return true;
	}
