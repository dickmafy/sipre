...
public class BoletaDetalleEjbBean extends
	...
	public SipreBoletaDetalle saveDetalle(SipreBoletaDetalle boleta) {
		try{
			...
			q.setParameter(6, boleta.getCbdTipConcpto()!=null ?boleta.getCbdTipConcpto():"");
			q.setParameter(7, boleta.getCbdCodIngDesc()!=null ?boleta.getCbdCodIngDesc():"");
			q.setParameter(8, boleta.getVbdDscIngDesc()!=null ?boleta.getVbdDscIngDesc():"");
			q.setParameter(9, boleta.getNbdMonto()!=null ?boleta.getNbdMonto():"");
			q.setParameter(10,boleta.getNbdNumCuoTotal()!=null ?boleta.getNbdNumCuoTotal():"");
			q.setParameter(11,boleta.getNbdNumCuoPagada()!=null ?boleta.getNbdNumCuoPagada():"");
			q.setParameter(12,boleta.getCbdIndSubtitulo()!=null ?boleta.getCbdIndSubtitulo():"");
