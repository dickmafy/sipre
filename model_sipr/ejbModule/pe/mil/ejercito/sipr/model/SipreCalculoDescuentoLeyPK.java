...
public class SipreCalculoDescuentoLeyPK implements Serializable {
    ...
    public SipreCalculoDescuentoLeyPK(String ctpCodigo, String ccdCodigo, String cpersonaNroAdm, String cplanillaMesProceso, short nplanillaNumProceso) {
    ...
    public String toString() {
        return "pe.mil.ejercito.sipr.model.SipreCalculoDescuentoLeyPK[ ctpCodigo=" + ctpCodigo + ", ccdCodigo=" + ccdCodigo + ", cpersonaNroAdm=" + cpersonaNroAdm + ", cplanillaMesProceso=" + cplanillaMesProceso + ", nplanillaNumProceso=" + nplanillaNumProceso + " ]";
    }
