...
public class SipreCalculoQuintaCategoriaPK implements Serializable {
    ...
    public String toString() {
        return "pe.mil.ejercito.sipr.model.SipreCalculoQuintaCategoriaPK[ cpersonaNroAdm=" + cpersonaNroAdm + ", cplanillaMesProceso=" + cplanillaMesProceso + ", nplanillaNumProceso=" + nplanillaNumProceso + " ]";
    }
