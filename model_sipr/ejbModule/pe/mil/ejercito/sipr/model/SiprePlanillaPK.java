...
public class SiprePlanillaPK implements Serializable {
	...
	public String toString() {
		return "pe.mil.ejercito.sipr.model.SiprePlanillaPK[ cpersonaNroAdm=" + cpersonaNroAdm + ", cplanillaMesProceso="
				+ cplanillaMesProceso + ", nplanillaNumProceso=" + nplanillaNumProceso + " ]";
	}
