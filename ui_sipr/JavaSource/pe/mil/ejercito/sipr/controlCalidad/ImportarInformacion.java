...
@ManagedBean(name = "importarInformacion")
@ViewScoped
public class ImportarInformacion extends MainContext implements Serializable {
	...
	public void moverCopereATmpPersonal() {
		...
		for (PersonalPlanillas personaCopere : listPersonalPlanillas) {
			...
			try {
				...
				cExito++;
				addGenericMensaje(" se guardo el CIP " + tmpCip + " en Tmp Persona Correctamente.",
						"Moviendo Data..",
